...
create_CV_object <-  function(data_location,
  ...
  if(is_google_sheets_location){
    ...
    cv$pr_skills     <- read_gsheet(sheet_id = "program_skills")
    ...
    cv$pr_skills       <- readr::read_csv(paste0(data_location, "program_skills"), skip = 1)
...
print_pr_skill_bars <- function(cv, out_of = 5, bar_color = "#002f6a", bar_background = "#d9d9d9", glue_template = "default"){
